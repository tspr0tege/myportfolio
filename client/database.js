...
export const projects = [
  {
    ...
    description: 'This is a personal passion project that I have turned into a personal odyssey.\n\nThe original project was a 2 day MVP project assigned during Hack Reactor, that amounted to little more than a React driven todo list. When revisiting it months later, I concluded that the data structure, the code structure, and everything was irredeemably wrong. So I completely rewrote it from the ground up and used Stormdb as a JSON based test database. A couple months later I had the same experience.At one point I had it hosted on Heroku with a Postgres database running.\n\nThe newest iteration is something I am taking more seriously, and would like to publish as a legitimate app. As such, I\'m keeping the work private (at least for now), and have implemented Font Awesome, game-icons, (via direct SVG imports in React using @svgr/webpack), Auth0, along with a substantially more robust code structure and purposefully crafted Postgres database.',
  ...
  },
  {
    ...
    description: 'Due to the proprietary nature of the work, I agreed to not publicly expose any of the code I produced for the project. What I will say is it used a serverless architecture, and vanilla Javascript with the Geolocation API. This was my first experience with Geolocation, and so I do have an experimental codepen I used (linked above) to try out things. I hope this gives some insight into my thought process.',
  ...
  },
  {
    ...
    description: 'Ah, yes… the ubiquitous weather app.\n\nI built this strictly as an example of consuming an API. It was also my first experiment with css-loader, and the dotenv npm package.  Originally deployed to Heroku on a free server.',
